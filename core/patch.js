export function patchInit(Mee) {
  Mee.prototype.createElement = function(node, isSvg) {
      let _mee = this;
      var element =
  ...
  Mee.prototype.patch = function(parent, element, oldNode, node, isSvg) {
